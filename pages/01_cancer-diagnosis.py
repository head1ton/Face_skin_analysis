...
def get_clean_data():
    df = pd.read_csv(os.path.join(base_dir, 'cancer-diagnosis.csv'))
    ...
    fig.add_trace(
        go.Scatterpolar(
            r=[input_data['radius_worst'], input_data['texture_worst'],
               ...
               input_data['area_worst'], input_data['smoothness_worst'],
