...
st.sidebar.subheader("설명")
st.sidebar.write("1. 그냥 이런것도 된다~ 라고 보세요...")
st.sidebar.write("2. 분석 수치는 모두 각각 데이터 수집 후 학습 후에 나와야하는 건데 샘플로 만드는 거라 수치는 대부분 랜덤값임.")
st.sidebar.write("3. Cloud 무료 호스팅이라 지원되는 카메라로 변경했더니 구림.. 이것도 나중에 변경할 거임..")
st.sidebar.write("4. TODO")
st.sidebar.write(" 4_1. 얼굴 부위별 랜드마크 재 설정")
st.sidebar.write(" 4_2. 얼굴 부위별 랜드마크 표시 변경")
st.sidebar.write(" 4_3. 얼굴 부위별 피부 상태 분석 모델 변경")
st.sidebar.write(" 4_4. 부위별 상태에 대한 분석 수치 변경")
st.sidebar.write(" 4_5. 수치 모델링 및 분석 후 적용")
st.sidebar.write(" 4_6. 수치 적용 후 UI 변경")
st.sidebar.write(" 4_7. 얼굴 피부에 대한 컨텐츠 추가")
st.sidebar.write(" 4_8. 전문적인 피부점검 보고서 추가")
st.sidebar.write(" 4_9. 비지니스 컨텐츠 추가")
st.sidebar.write(" 4_10. 추천 화장품 내외부 연결")
st.sidebar.write(" 4_11. 추천 화장품의 사용 시 관리 컨텐츠 추가")
st.sidebar.write(" 4_12. 고객 피드백 추가 설정")
st.sidebar.write(" 4_13. 기타 등등")
st.sidebar.write("5. 대충 만들어지면 MVP 로 웹/앱 으로 개발 예정")
st.sidebar.write("6. History : 2025-04-25 mvp 시작.")
